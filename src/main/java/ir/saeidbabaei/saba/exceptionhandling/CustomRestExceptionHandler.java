package ir.saeidbabaei.saba.exceptionhandling;
...
public class CustomRestExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public final Object handleEntityNotFoundException(EntityNotFoundException ex, final WebRequest request) {
        logger.info(ex.getClass().getName());
        //
        final String error = ex.getMessage() + " not found";
    ...
    public final Object handleAccessDeniedException(AccessDeniedException ex, final WebRequest request) {
        logger.info(ex.getClass().getName());
        //
    ...
    public final Object handleBadCredentialsException(BadCredentialsException ex, final WebRequest request) {
        logger.info(ex.getClass().getName());
        //
        final String error = ex.getMessage();
